...
async def run_software_development_team():
    ...
    # result = await team_chat.run_stream(task=task) # async_generator 错误使用
    # async for chunk in team_chat.run_stream(task=task):
    #     print(chunk, end="")
...
#         UserMessage(content="介绍你自己", source="user")
#     ])
#     print(result)
#     await client.close()
#
